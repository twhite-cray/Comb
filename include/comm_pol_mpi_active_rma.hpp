...
template < >
struct MessageGroup<MessageBase::Kind::send, mpi_active_rma_pol, mpi_type_pol>
  : detail::MessageGroupInterface<MessageBase::Kind::send, mpi_active_rma_pol, mpi_type_pol>
{
  using base = detail::MessageGroupInterface<MessageBase::Kind::send, mpi_active_rma_pol, mpi_type_pol>;
...
template < >
struct MessageGroup<MessageBase::Kind::recv, mpi_active_rma_pol, mpi_type_pol>
  : detail::MessageGroupInterface<MessageBase::Kind::recv, mpi_active_rma_pol, mpi_type_pol>
{
  using base = detail::MessageGroupInterface<MessageBase::Kind::recv, mpi_active_rma_pol, mpi_type_pol>;
